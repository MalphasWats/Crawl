...
static const __flash Tile TILES[] = {
    ...
    { .data={0x00, 0x00, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00,}, .flags=0b00000000, },  // Floor
    ...
    { .data={0xe5, 0xf9, 0xfc, 0xfd, 0xf9, 0xe1, 0x0e, 0xf1,}, .flags=0b00000000, },  // Cave BR (Door)
    { .data={0x87, 0xa1, 0xa8, 0xaa, 0xaa, 0xa8, 0xa1, 0x87,}, .flags=0b00000000, },  // Stairs Up
    { .data={0xe1, 0x85, 0x15, 0x55, 0x55, 0x15, 0x85, 0xe1,}, .flags=0b00000000, },  // Stairs Down
    { .data={0xfe, 0x03, 0xfd, 0xfd, 0xfd, 0xfd, 0x03, 0xfe,}, .flags=0b10000000, },  // Door Closed
    { .data={0xfe, 0x03, 0x01, 0x01, 0x01, 0x01, 0x03, 0xfe,}, .flags=0b00000000, },  // Door Open
    { .data={0xfe, 0xa9, 0x9b, 0xcd, 0x89, 0xdb, 0x89, 0xfe,}, .flags=0b10000000, },  // Wall Block
    { .data={0x00, 0xf8, 0x94, 0x94, 0xb4, 0x94, 0x94, 0xf8,}, .flags=0b00000000, },  // Chest Closed
    { .data={0x00, 0xfe, 0x9d, 0x9d, 0xbd, 0x9d, 0x9d, 0xfe,}, .flags=0b00000000, },  // Chest Open
    { .data={0x00, 0x38, 0x4c, 0x92, 0x92, 0x92, 0x4c, 0x38,}, .flags=0b00000000, },  // Vase 1
};
